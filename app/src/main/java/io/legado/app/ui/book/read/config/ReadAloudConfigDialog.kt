    ...
    class ReadAloudPreferenceFragment : ComposeSettingFragment(),
        ...
        private fun readingItems(): List<SettingItemSpec> {
            return listOf(
                ...
                switch(
                    key = PreferKey.readAloudFollowPage,
                    title = getString(R.string.read_aloud_follow_page),
                    summary = getString(R.string.read_aloud_follow_page_summary),
                    defaultValue = true
                ),
                switch(
